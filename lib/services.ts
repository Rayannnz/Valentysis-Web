...
export const services: Service[] = [
  ...
  },
  {
    ...
    lead: "Trained remote staff for real estate, law firms, medical practices, accountancy, and ecommerce — handling the work your front desk and back office can't keep up with.",
    summary:
      "This isn't a generic call centre. We place people who already understand your industry's paperwork, deadlines, and tone — paralegals, front desk staff, schedulers, bookkeepers, and support agents who work inside your systems and follow your process. You keep control and oversight; we handle the volume.",
    homeDesc:
      "Trained remote staff for real estate, legal, medical, accountancy, and ecommerce teams — paralegal work, front desk, scheduling, books, and buyer care.",
    ...
    fits: [
      ...
      },
      {
        ...
        desc: "Calls go unanswered, authorizations sit pending, and patients wait — while staff are already at capacity.",
      },
    ],
    detail: {
      eyebrow: "In detail",
          ...
          items: [
            {
              ...
              desc: "A trained remote receptionist answering your practice line, greeting patients, routing calls, and taking messages that actually get actioned.",
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              desc: "Pre-sale questions, product queries, and marketplace Q&A answered accurately and fast, so buyers get what they need before they leave the page.",
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    lead: "SEO, paid ads, content, and lead generation run as one program — with reporting that shows exactly what brought in the business.",
    summary:
      "We plan and run digital marketing built around leads and sales, not impressions. Search visibility, paid campaigns, landing pages, social, and brand positioning handled by one team — so the channels reinforce each other instead of being stitched together from freelancers every month.",
    homeDesc:
      "SEO, paid ads, content, landing pages, and lead generation — run as one program with reporting tied to sales.",
    ...
    offerings: [
      ...
      },
      {
        ...
        desc: "Landing pages, content, and social built to turn attention into enquiries and sales.",
      },
      {
          ...
          items: [
            {
              ...
              desc: "Account structure, tracking, and conversion setup done properly before a single rupee of budget goes live.",
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              desc: "Monthly reporting on reach, engagement, and the traffic and enquiries social actually drove.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              desc: "Colour, type, and imagery direction so your brand is recognisable before anyone reads a word.",
            },
            {
