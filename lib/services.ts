...
export const services: Service[] = [
  ...
  },
  {
    ...
    summary:
      "We plan, create, and run social programs that match your brand voice and business goals. From content calendars to paid amplification and community replies, you get a consistent presence without stitching together freelancers every month.",
    homeDesc:
    ...
    panelCopy: "A calendar, a voice, and weekly metrics — so social stops being an afterthought.",
    offerings: [
      {
      ...
      {
        title: "Paid social & reporting",
        desc: "Targeted boosts and clear monthly reports on reach, engagement, and conversion signals.",
      },
    ],
    fits: [
      {
        label: "Brands",
        title: "Building a consistent social presence",
        desc: "You know social matters, but posting is inconsistent and nobody owns the strategy.",
      },
      {
        label: "Product teams",
